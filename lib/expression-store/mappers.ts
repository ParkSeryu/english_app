...
export type SupabaseExpressionStatsRow = Pick<ExpressionCard, "id" | "unknown_count" | "review_count" | "last_result" | "last_reviewed_at" | "source_order" | "created_at">;

export const EXPRESSION_CARD_COLUMNS = "id, expression_day_id, owner_id, english, korean_prompt, nuance_note, structure_note, grammar_note, user_memo, source_order, unknown_count, review_count, last_result, last_reviewed_at, created_at, updated_at";
export const EXPRESSION_STATS_COLUMNS = "id, unknown_count, review_count, last_result, last_reviewed_at, source_order, created_at";
